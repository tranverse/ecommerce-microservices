...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiErrorResponse> handleOptimisticLock(
        ...
        return response(
                ...
                "Product was updated by another request; reload it and retry",
                List.of(),
                request
        );
    }
    ...
    ResponseEntity<ApiErrorResponse> handleDataIntegrity(
        ...
        log.warn("Database constraint rejected the product operation", exception);
        return response(
                HttpStatus.CONFLICT,
                ErrorCode.DATA_INTEGRITY_CONFLICT,
                "The request conflicts with existing product data",
                List.of(),
                request
        );
    }
    ...
    ResponseEntity<ApiErrorResponse> handleUnexpected(Exception exception, HttpServletRequest request) {
        log.error("Unhandled product service error", exception);
        return response(
