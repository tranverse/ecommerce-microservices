...
import com.example.ecommerce.user.domain.AddressNotOwnedException;
...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiErrorResponse> handleAddressNotFound(
            AddressNotOwnedException exception,
    ...
    ResponseEntity<ApiErrorResponse> handleOptimisticLock(
        ...
        return response(
                ...
                "Profile was updated by another request; reload it and retry",
                List.of(),
                request
        );
    }
    ...
    ResponseEntity<ApiErrorResponse> handleDataIntegrity(
        ...
        log.warn("Database constraint rejected the user operation", exception);
        return response(
                HttpStatus.CONFLICT,
                ErrorCode.DATA_INTEGRITY_CONFLICT,
                "The request conflicts with existing user data",
                List.of(),
                request
        );
    }
