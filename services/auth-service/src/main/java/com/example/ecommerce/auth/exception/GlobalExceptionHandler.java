...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiErrorResponse> handleDataIntegrity(
        ...
        log.warn("Database constraint rejected the authentication operation", exception);
        return response(HttpStatus.CONFLICT, ErrorCode.DATA_INTEGRITY_CONFLICT,
                "The request conflicts with existing authentication data", List.of(), request);
    }
    ...
    ResponseEntity<ApiErrorResponse> handleUnexpected(Exception exception, HttpServletRequest request) {
        log.error("Unhandled auth service error", exception);
