...
class OutboxPublisherServiceTest {
    ...
    @Test
    void retainsAFailedEventWithSanitizedErrorAndBackoff() {
        OutboxEvent event = event();
    ...
    private OutboxEvent event() {
        ...
        EventEnvelope<PaymentCompletedV1> envelope = new EventEnvelope<>(
                UUID.randomUUID(),
        ...
        return OutboxEvent.create(
                envelope,
                "Payment",
                PaymentEventFactory.PAYMENT_EVENTS_TOPIC,
                orderId.toString(),
